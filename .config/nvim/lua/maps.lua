...
map('n', '<leader>u',    ':UndoTreeShow<CR>',                             { noremap = true, silent = true})
map('n', '<leader><CR>', ':luafile ~/.config/nvim/init.lua<CR>',          { noremap = true, silent = true })
...
map('n', '<leader>ghw',  ':h <C-R>=expand("<cword>")<CR><CR>',            { noremap = true, silent = true })
map('n', '<leader>bs',   '/<C-R>=escape(expand("<cword>"), "/")<CR><CR>', { noremap = true, silent = true })
...
-- LSP maps 
map('n', '<leader>vd',   ':lua vim.lsp.buf.definition()<CR>',             { noremap = true, silent = true })
map('n', '<leader>vi',   ':lua vim.lsp.buf.implementation()<CR>',         { noremap = true, silent = true })
map('n', '<leader>vsh',  ':lua vim.lsp.buf.signature_help()<CR>',         { noremap = true, silent = true })
map('n', '<leader>vrr',  ':lua vim.lsp.buf.references()<CR>',             { noremap = true, silent = true })
...
map('n', '<leader>vrc',  ':lua search_dotfiles()<CR>',                    { noremap = true, silent = true })
map('n', '<leader>fm',   '<cmd>Telescope file_browser<CR>',               { noremap = true })

-- Command mode maps
map('c', '<CR>',         [[wildmenumode() ? "\<C-Y>" : "\<CR>"]],         { noremap = true, expr = true })
